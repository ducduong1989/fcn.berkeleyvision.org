...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get --no-install-recommends install -yq ca-certificates libglib2.0-0 poppler-utils supervisor libgl1 tzdata git libxrender1 ffmpeg libsm6 nano libxext6 xcb && \
